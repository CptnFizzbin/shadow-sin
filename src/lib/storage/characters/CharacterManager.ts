...
export class CharacterManager {
  ...
  private async migrateCharacter (character: { version: number }): Promise<PlayerCharacterData> {
    ...
    const playerCharacter: PlayerCharacterData = characterData as PlayerCharacterData;
