...
import { GameEffectType } from "#/lib/system/game-effect-data.ts"
...
import { ImplantGrade, ImplantLocation } from "#/lib/system/gear/implant-data.ts"
import type { LicenseData } from "#/lib/system/gear/license-data.ts"
import type { SinData } from "#/lib/system/gear/sin-data.ts"
import type { SoftwareData } from "#/lib/system/gear/software-data.ts"
import type { VehicleData } from "#/lib/system/gear/vehicle-data.ts"
import type { FirearmAccessoryData, FirearmData } from "#/lib/system/gear/weapon-data.ts"
import { FirearmAttachmentPoint, FirearmType, WeaponType } from "#/lib/system/gear/weapon-data.ts"
import { GearType } from "#/lib/system/gear-type.ts"
import type { ItemData } from "#/lib/system/item-data.ts"
import { createItem, createItemMap } from "#/lib/system/item-data.ts"
