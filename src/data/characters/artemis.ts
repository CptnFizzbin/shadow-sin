  ...
  gear: {
    ...
    [GearType.implant]: [
      ...
      createGear<ImplantData>({
        ...
        capacity: 12,
        items: [
          createGear({ name: "Smartlink", type: "cyberware", cost: 4800, notes: "Capacity cost 3." }),
          createGear({ name: "Imagelink", type: "cyberware", cost: 960 }),
          createGear({ name: "Low-Light Vision", type: "cyberware", cost: 900 }),
          createGear({ name: "Vision Enhancement", type: "cyberware", cost: 4800 }),
          createGear({ name: "Vision Magnification", type: "cyberware", cost: 2400 })
        ]
      }),
      createGear<ImplantData>({
        ...
        cost: 47250,
        location: "head",
        effects: [{ type: "attrBonus", target: "attr.logic", modifier: 3 }]
      }),
      createGear<ImplantData>({
      ...
      createGear<ImplantData>({
        ...
        location: "head",
        effects: [
          { type: "modifier", target: "attr.reaction", modifier: 2 },
          { type: "modifier", target: "initiative", modifier: 2 }
        ]
      })
    ],
    ...
    [GearType.device]: [
      createGear({
        ...
        items: [
          createGear({ name: "FN-HAR Targeting Autosoft", type: GearType.software, cost: 4000, rating: 8 }),
          createGear({ name: "Clearsight Autosoft", type: GearType.software, cost: 4000, rating: 8 }),
          createGear({ name: "Evasion Autosoft", type: GearType.software, cost: 4000, rating: 8 }),
          createGear({ name: "Maneuvering Autosoft", type: GearType.software, cost: 4000, rating: 8 }),
          createGear({ name: "Electronic Warfare Autosoft", type: GearType.software, cost: 4000, rating: 8 }),
          createGear({ name: "Black Knight Targeting Autosoft", type: GearType.software, cost: 4000, rating: 8 })
        ]
      }),
      createGear({
