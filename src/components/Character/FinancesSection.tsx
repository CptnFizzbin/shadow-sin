...
export const FinancesSection: FC = () => {
	...
	return (
		<Box>
			...
			<Typography variant="body2">Nuyen: {nuyen ? formatCurrency(nuyen.current) : "—"}</Typography>
			<Typography variant="body2">Karma: {karma ? karma.current : "—"} / {karma ? karma.total : "—"}</Typography>
		</Box>
	);
};
