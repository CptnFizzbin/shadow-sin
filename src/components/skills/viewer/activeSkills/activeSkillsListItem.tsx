...
import { DicePoolsStack, useViewSkillDialog } from "#/components/skills/viewer/viewSkillDialog.tsx"
...
import { AiAttributes, AttributeKey, AttributeLabels } from "#/system/model/attributes/attributeKey.ts"
