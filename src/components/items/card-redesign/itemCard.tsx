 ...
 */
export const ItemCard: FC<ItemCardProps> = ({ item, onOpen, onEdit, onRemove }) => {
  switch (item.itemType) {
    ...
    case ItemType.weapon:
      return <WeaponItemCard weapon={item as WeaponData} onOpen={onOpen} onEdit={onEdit} />

    case ItemType.armor:
      return <ArmorItemCard armor={item as ArmorData} onOpen={onOpen} onEdit={onEdit} />

    case ItemType.license:
      return <LicenseCard license={item as LicenseData} onOpen={onOpen} onEdit={onEdit} />

    case ItemType.sin:
      return <SinCard sin={item as SinData} onOpen={onOpen} onEdit={onEdit} />

    case ItemType.credstick:
      return <CredstickCard credstick={item as CredstickData} onOpen={onOpen} onEdit={onEdit} />

    case ItemType.device:
      return <DeviceItemCard device={item as DeviceData} onOpen={onOpen} onEdit={onEdit} />

    case ItemType.program:
      return <ProgramItemCard program={item as ProgramData} onOpen={onOpen} onEdit={onEdit} />

    case ItemType.implant:
      return <ImplantItemCard implant={item as ImplantData} onOpen={onOpen} onEdit={onEdit} />

    case ItemType.vehicle:
      return <VehicleItemCard vehicle={item as VehicleData} onOpen={onOpen} onEdit={onEdit} />

    default:
      return <BasicItemCard item={item} onOpen={onOpen} onEdit={onEdit} onRemove={onRemove} />
  }
}
