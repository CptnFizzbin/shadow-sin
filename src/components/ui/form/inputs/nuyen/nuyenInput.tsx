...
export interface NuyenInputProps extends Omit<MuiTextFieldProps, "type" | "value" | "onChange"> {
 ...
 */
export const NuyenInput: FC<NuyenInputProps> = ({ value, onChange, onBlur, ...props }) => {
