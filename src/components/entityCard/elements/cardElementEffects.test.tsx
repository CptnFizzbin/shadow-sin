...
import { CardElementEffect } from "./cardElementEffect.tsx"
...
describe("CardElementEffects", () => {
  ...
  it("renders nothing when there are no effects", () => {
    const { container } = render(<CardElementEffect effects={[]} />, { wrapper: ThemeWrapper })

    expect(container.firstChild).toBeNull()
  })

  it("renders nothing when effects is undefined", () => {
    const { container } = render(<CardElementEffect effects={undefined} />, { wrapper: ThemeWrapper })
