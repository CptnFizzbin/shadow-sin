...
describe("DataCardSlotStat", () => {
  ...
  it.each([
    ...
    render(<DataCardSlotStat label="X" value="1" type={type} />, { wrapper: ThemeWrapper })
  ...
  it("has no color class for untyped stats", () => {
    render(<DataCardSlotStat label="X" value="1" />, { wrapper: ThemeWrapper })
