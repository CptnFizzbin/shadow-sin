...
export const GearProvider: FC<GearProviderProps> = ({ gear, children }) => {
...
export function useGear<T extends GearData = GearData>(
  gearId: RecordId | undefined,
): T | undefined {
...
export function useFindGear<T extends GearData = GearData>(
  filter: GearFilter,
): T | undefined {
...
export function useFilterGear<T extends GearData = GearData>(
  filter: GearFilter,
): T[] {
  return useAllGear()
    .filter(filter)
